...
insert  into `address`(`addressid`,`addpro`,`userid`,`isdefault`,`addcity`,`addarea`,`addinfo`,`addtel`,`addname`) values ('a784657','河北省','u123456',0,'石家庄市','新华区','体育路青溪小区','7652734','小李'),('a734788','河北省','u123456',0,'石家庄市','裕华区','图书路35号','3467288','李');
